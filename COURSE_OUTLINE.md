...
| Item | Details |
|---|---|
| Term | September 9–December 7, 2026 |
| Class meetings | Fridays, 9:30 a.m.–12:20 p.m. |
| Room | WMC 4602 |
...
- formulate consumer, firm, market, and allocation problems with precise domains and constraints;
- derive and interpret demand, supply, welfare, and revealed-preference restrictions;
- state the hypotheses and logical structure of representation, duality, and equilibrium results;
- connect classical theory to uncertainty, stochastic choice, limited attention, matching, and quantitative policy models; and
- read a formal argument critically and identify which steps are proved in Lean, proved in the text, or delegated to a cited theorem.

## Assessment

Problem sets count for 10%, the midterm examination for 40%, and the final examination for 50%. Problem sets are released in teaching order. Solutions and answer keys are distributed separately by the instructor and are not part of the main text or this public book repository.
...
Students requiring accommodations should contact SFU’s [Centre for Accessible Learning](https://www.sfu.ca/students/accessible-learning.html). Students should review SFU’s [academic-integrity policies](https://www.sfu.ca/policies), including S 10.02 and S 10.03.

Meeting dates and the position of assessments are tentative and may change with advance notice.
